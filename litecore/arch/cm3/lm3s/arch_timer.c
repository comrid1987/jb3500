...
//Private Const
static uint32_t const lm3s_tblTimerSysCtl[] = {
	SYSCTL_PERIPH_TIMER0,
	SYSCTL_PERIPH_TIMER1,
	SYSCTL_PERIPH_TIMER2,
	SYSCTL_PERIPH_TIMER3
};
static uint32_t const lm3s_tblTimerBase[] = {
	TIMER0_BASE,
	TIMER1_BASE,
	TIMER2_BASE,
	TIMER3_BASE
};
static uint_t const lm3s_tblTimerInt[] = {
	INT_TIMER0A,
	INT_TIMER0B,
	INT_TIMER1A,
	INT_TIMER1B,
...
{
	uint_t nBase = lm3s_tblTimerBase[nId >> 1];
