...
sys_res att7022_Reset(p_att7022 p, p_att7022_cali pCali)
{
	...
	att7022_WriteReg(p, ATT7022_REG_EAddMode, 1);			//ºÏÏàÄÜÁ¿ÈıÏàËÄÏß´úÊıºÍÏà¼Ó	
...
void att7022_PhaseCali2Seg(uint8_t nPhase) {
	...
	att7022_CaliEnable(); //ATT7022BĞ£ÕıÊ¹ÄÜ
	...
	att7022_CaliDisable(); //ATT7022BĞ£Õı½ûÖ¹
}
