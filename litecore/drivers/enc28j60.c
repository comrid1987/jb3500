...
//Internal Variables
static uint8_t enc28j60_nBank = 0;
static uint16_t enc28j60_nNextPacketPtr;


static uint32_t enc28j60_ReadOp(uint32_t op, uint32_t address)
{
	int nResult;
...
static void enc28j60_WriteOp(uint32_t op, uint32_t address, uint32_t data)
{
...
static void enc28j60_ReadBuffer(uint32_t len, uint8_t *data)
{
...
static void enc28j60_WriteBuffer(uint32_t len, uint8_t *data)
{
...
static void enc28j60_SetBank(uint32_t address)
{
...
static uint32_t enc28j60_Read(uint32_t address)
{
	//set the bank
...
static void enc28j60_Write(uint32_t address, uint32_t data)
{
	//set the bank
	enc28j60_SetBank(address);
	//do the write
...
static void enc28j60_PhyWrite(uint32_t address, uint32_t data)
{
...
static void enc28j60_PacketSend(void *packet, uint_t len)
{
	uint32_t nTmo = 100;
...
static uint32_t enc28j60_PacketReceive()
{
	OS_FRAME *frame;
	uint16_t rxstat;
	uint16_t len;
