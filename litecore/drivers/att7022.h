...
#define	REG_FailVoltage				0x29		//失压阈值设置
#define	REG_EAddMode				0x2a		//合相能量累加模式选择
#define	REG_GainAdc7				0x2b		//第七路ADC有效值校正
#define	REG_GCtrlT7Adc				0x2c		//温度/第七路ADC选择控制
#define	REG_EnlineFreq				0x2d		//基波测量使能控制
#define	REG_EnUAngle				0x2e		//电压夹角测量使能控制
#define	REG_SelectPQSU				0x2f		//基波电压功率输出选择
#define	REG_EnDtIorder				0x30		//电流相序检测使能控制
#define	REG_LineFreqPg				0x31		//基波功率校正
#define	REG_UADCPga					0x3f		//电压通道ADC增益选择


//------------------------------------------------------------------------
//ATT7022B command set
//------------------------------------------------------------------------
#define	CLEAR_CALIDATA				0xC3		//校正数据清除命令
#define	READ_CALIDATA     			0xC6		//读校正数据命令
#define	CALIDATA_WEN				0xC9		//校正数据写使能
#define	SOFTRST_CMD					0xd3		//软件复位命令
...
#define	MAX_VALUE1					8388608.0f	// 2 ^ 23 值
