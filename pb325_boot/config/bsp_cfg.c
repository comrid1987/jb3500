...
//-------------------------------------------------------------------------
	...
	t_gpio_def _tbl_bspGpio[] = {
		//LED
		GPIO_T_HC595,	GPIO_P1,	7,		GPIO_M_OUT_PP,		GPIO_INIT_HIGH,		//BEEP
...
//-------------------------------------------------------------------------
	...
	t_uart_def tbl_bspUartDef[BSP_UART_QTY] = {
		...
		//UART_T_TIMER,	1,	GPIO_P5,	4,	UART_MODE_IRQ,	GPIO_P5,	5,	UART_MODE_IRQ,	NULL,		NULL,	UART_FUN_NORMAL,	DEV_PIN_PP,
	};
#endif
