...
enum LCD_BIAS  { BIAS_3rd_4_STATES, BIAS_3rd_3_STATES,
                 BIAS_half_2_STATES, BIAS_half_3_STATES, BIAS_STATIC };
...
enum MASK { ZERO = 0x3F, ONE = 0x06, TWO = 0x5B, THREE = 0x4F, FOUR = 0x66,
	...
	IconPcnt=0x01, IconV=0x02, IconA=0x04, IconKW=0x08, Iconkvar=0x10, IconWarn=0x20, IconUSB=0x40, IconStatus=0x80,		/*Unit*/
	Icon_A =0x01, Icon_B =0x02, Icon_C =0x04, Icon_Sum =0x08, Icon_Work=0x10, Usb=0x40,		/*Phase*/
	IconPhone=0x01,
	};

enum ICON
{   
 	iDIGIT1, iDIGIT2, iDIGIT3, iDIGIT4, iDIGIT5, iDIGIT6, iDIGIT7, iDIGIT8, iDPS,
	iConList, iConCheck, iConUnit, iConPhase, iDIGIT0, iConTri, iConCap, iConGprs,
	iConOnline
};

enum Dis
{
	 Dis_Va, Dis_Vb, Dis_Vc, Dis_Ia, Dis_Ib, Dis_Ic, Dis_In, Dis_Pa, Dis_Pb, Dis_Pc, Dis_Pn, Dis_Qa, Dis_Qb, Dis_Qc, 
	 Dis_Qn, Dis_PQa, Dis_PQb, Dis_PQc, Dis_PQn, Dis_Addr1, Dis_Addr2, Dis_Time, Dis_Date
};
