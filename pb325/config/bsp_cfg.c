...
//-------------------------------------------------------------------------
    ...
    t_uart_def tbl_bspUartDef[BSP_UART_QTY] = {
        ...
        UART_T_INT,     2,  GPIO_P3,    1,  UART_MODE_POLL, GPIO_P3,    0,  UART_MODE_IRQ,  NULL,       NULL,   UART_FUN_NORMAL,    DEV_PIN_PP,
        UART_T_TIMER,   0,  GPIO_P2,    4,  UART_MODE_IRQ,  GPIO_P4,    4,  UART_MODE_IRQ,  NULL,       0,      UART_FUN_IRDA,      DEV_PIN_PP, //发送脚常低
    };
#endif
